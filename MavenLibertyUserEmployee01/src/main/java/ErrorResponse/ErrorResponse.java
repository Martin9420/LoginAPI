...
public enum ErrorResponse {
	...
	E409PUT(Response.Status.CONFLICT.getStatusCode(),"E409","レコードを更新できません"),
	E409DELETE(Response.Status.CONFLICT.getStatusCode(),"E409","レコードを削除できません"),
	...
	private ErrorResponse(int ErrorStatus, String ErrorStatusCodeMessage, String ErrorMessage) {
